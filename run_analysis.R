getwd()################################################################################
# 
#  This script uses the dataset "Human Activity Recognition Using 
#  Smartphones Data Set" from the UCI Machine Learning Repository.
#  URL: http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
#
################################################################################

# Read in the testing and training data
subject_test  <- read.delim(file="C:/Users/Administrator/UCI HAR Dataset/test/subject_test.txt", col.names="subject")
subject_train <- read.delim(file="C:/Users/Administrator/UCI HAR Dataset/train/subject_train.txt", col.names="subject")
y_test        <- read.delim(file="C:/Users/Administrator/UCI HAR Dataset/test/y_test.txt", col.names="activity")
y_train       <- read.delim(file="C:/Users/Administrator/UCI HAR Dataset/train/y_train.txt", col.names="activity")
